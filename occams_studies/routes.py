...
def includeme(config):
    ...
    config.add_route('studies.study_external_services',     '/{study}/external-services',           factory=models.StudyFactory, traverse='/{study}')
    config.add_route('studies.study_external_service',      '/{study}/external-services/{service}', factory=models.StudyFactory, traverse='/{study}/{service}')
